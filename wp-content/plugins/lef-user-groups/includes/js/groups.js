var lefGroupWishlist = (function() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                response.forEach(function(wishlist) {
                    ...
                    item.textContent = wishlist.title;  // Ensure 'title' is used correctly
    ...
    function addWishlistToGroup(wishlistID) {
        ...
        // Ensure the message element exists before continuing
        if (!message) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                //currently never a succes and will trigger the else
                if (response.success) {
                    // Show a success message
                    message.textContent = `Your wishlist has been added to this group`;
                    message.style.display = "block";
                    
                    // Fade out message after 30 seconds
                    setTimeout(() => {
